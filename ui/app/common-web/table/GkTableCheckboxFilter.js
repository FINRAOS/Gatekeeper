...
class PetTableCheckboxFilter{
    ...
    static GkTableCheckboxFilterFactory(input, filters){
        let filter = new PetTableCheckboxFilter(input, filters);
        return filter.execute();
    }
}

export default PetTableCheckboxFilter;
