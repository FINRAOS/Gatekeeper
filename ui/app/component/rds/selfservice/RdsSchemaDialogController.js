...
class RdsSchemaDialogController {
    constructor($mdDialog, gkSchemaService, database, account, region){
        ...
        vm.fetched = false;
        vm.schemaPromise = gkSchemaService.search({account:account.alias, region: region.name, sdlc: account.sdlc, instanceName: database.name, instanceId: database.instanceId, instanceType : vm.database.databaseType});
