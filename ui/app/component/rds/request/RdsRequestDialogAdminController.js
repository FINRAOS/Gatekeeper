...
class RdsRequestDialogAdminController extends GatekeeperRequestDialogAdminController {
    constructor($rootScope, $mdDialog, $mdToast, gkRequestService, row){
        ...
        //This status check will be different for RDS
        //May want to normalize on rds-request side?
...
export default RdsRequestDialogAdminController