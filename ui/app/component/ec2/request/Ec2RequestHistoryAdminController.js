...
class Ec2RequestHistoryAdminController extends GatekeeperRequestDialogAdminController {
    constructor($rootScope, $mdDialog, $mdToast, gkRequestService, row){
        ...
        this.actions.unshift(update);
    }


}

export default Ec2RequestHistoryAdminController