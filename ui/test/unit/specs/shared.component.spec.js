...
describe('GateKeeper UI shared gatekeeper component', function () {
    ...
    describe('DataServices', function () {
        ...
        it('GrantDataService should call fetch properly and return a promise', function () {
            ...
            var testBundle = {hours:5, users:{name:'bob', email:'bob@thing' }, account:"TEST", accountSdlc:"sdlc", region:"us-west-2", instances:{instance:'hello'}, ticketId: 'TST-123', requestReason:'test request explanation', platform: "Test platform"};
            let promise = dataservice.post(testBundle.hours, testBundle.users, testBundle.account, testBundle.accountSdlc, testBundle.region, testBundle.instances, testBundle.ticketId, testBundle.requestReason, testBundle.platform);
            expect(promise).toBe('stubbed');
