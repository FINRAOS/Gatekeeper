...
public class RdsRevokeAccessQuery extends RdsQuery {
    ...
    public RdsRevokeAccessQuery(String account, String accountId, String region, String sdlc, String address, String dbInstanceName, String dbEngine, boolean rdsIAMAuth, String user, RoleType role) {
        super(account, accountId, region, sdlc, address, dbInstanceName, dbEngine, rdsIAMAuth);
        this.user = user;
        this.role = role;
    }

    public RdsRevokeAccessQuery(String account, String accountId, String region, String sdlc, String address, String dbInstanceName, String dbEngine, boolean rdsIAMAuth) {
        super(account, accountId, region, sdlc, address, dbInstanceName, dbEngine, rdsIAMAuth);
    }
