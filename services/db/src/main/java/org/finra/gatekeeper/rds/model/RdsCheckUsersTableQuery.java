...
public class RdsCheckUsersTableQuery extends RdsQuery {
    ...
    public RdsCheckUsersTableQuery(String account, String accountId, String region, String sdlc, String address, String dbInstanceName, String dbEngine, boolean rdsIAMAuth) {
        super(account, accountId, region, sdlc, address, dbInstanceName, dbEngine, rdsIAMAuth);
    }

    public RdsCheckUsersTableQuery(String account, String accountId, String region, String sdlc, String address, String dbInstanceName, String dbEngine, boolean rdsIAMAuth, List<String> users) {
        super(account, accountId, region, sdlc, address, dbInstanceName, dbEngine, rdsIAMAuth);
        this.users = users;
    }
