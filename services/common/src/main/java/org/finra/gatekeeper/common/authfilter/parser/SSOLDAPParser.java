...
public class SSOLDAPParser implements UserLDAPParser {

    private final String userIdHeader;

    public SSOLDAPParser(String userIdHeader){
    ...
    public Optional<IGatekeeperLDAPUserProfile> parse(HttpServletRequest req) {
        ...
        if (name != null) {
            userProfile = Optional.of(new GatekeeperLDAPUserProfile(name, SOURCE_NAME));
        }
        return userProfile;
    }
}
